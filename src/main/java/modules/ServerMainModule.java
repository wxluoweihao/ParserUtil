...
import modules.SystemConnectorModule;
...
import modules.CoordinatorModule;
...
//        jaxrsBinder(binder).bind(StatusResource.class);
        ...
        newOptionalBinder(binder, PluginManager.PluginsProvider.class).setDefault()
...
//        binder.bind(ExecutorCleanup.class).in(Scopes.SINGLETON);
    ...
    @Provides
    @Singleton
    private NodeScheduler initNodeScheduler(InternalNodeManager nodeManager, NodeSchedulerConfig nodeSchedulerConfig, FinalizerService finalizerService) {
        return new NodeScheduler(new UniformNodeSelectorFactory(nodeManager, nodeSchedulerConfig, new NodeTaskMap(finalizerService)));
    }

    @Provides
    @Singleton
    private ResourceGroupManager<?> initResourceGroupManager() {
        return new NoOpResourceGroupManager();
    }

    @Provides
    @Singleton
    private TaskManagerConfig initTaskManagerConfig() {
    ...
    @Singleton
    @ForStartup
    private static JsonCodecFactory initJsonCodecFactory() {
