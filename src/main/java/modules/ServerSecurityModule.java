        ...
        extends AbstractConfigurationAwareModule
{
    ...
    protected void setup(Binder binder)
    {
        ...
        install(authenticatorModule("certificate", CertificateAuthenticator.class, certificateBinder -> {
            newOptionalBinder(certificateBinder, HttpServer.ClientCertificate.class).setBinding().toInstance(REQUESTED);
    ...
    @Provides
    @Singleton
    private InternalCommunicationConfig initInternalComminication() {
        return new InternalCommunicationConfig();
    }

    @Provides
    @Singleton
    private HttpRequestSessionContextFactory initHttpRequestSessionContextFactory(
            PreparedStatementEncoder preparedStatementEncoder,
            MetadataManager metadataManager,
            AccessControl accessControl
    ) {
        return new HttpRequestSessionContextFactory(
                preparedStatementEncoder,
                metadataManager,
                ImmutableSet::of,
                accessControl);
    }
